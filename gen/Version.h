...
namespace VersionInfo {
    ...
    constexpr std::string_view VERSION_STR = "GDExtensionTemplate v0.1.11-desktop-player-8-g8c0fa69";
    ...
    // If there are no commits since the last tag, only the tag is shown.
    constexpr std::string_view VERSION_SHORT_STR = "v0.1.11-desktop-player-8-g8c0fa69";

    // The full git SHA1 hash as a string.
    // This is generated using the current git commit information.
    constexpr std::string_view GIT_SHA1_STR = "8c0fa69ea30c5910898ca60a69f6261697c28333";
}
